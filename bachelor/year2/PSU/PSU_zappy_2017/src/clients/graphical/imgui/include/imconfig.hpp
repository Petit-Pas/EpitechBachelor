//-----------------------------------------------------------------------------
// USER IMPLEMENTATION
// This file contains compile-time options for src.
// Other options (memory allocation overrides, callbacks, etc.) can be set at runtime via the ImGuiIO structure - src::GetIO().
//-----------------------------------------------------------------------------
...
//---- Include imgui_user.h at the end of imgui.hpp
...
//---- Tip: You can add extra functions within the src:: namespace, here or in your own headers files.
//---- e.g. create variants of the src::Value() helper for your low-level math types, or your own widgets/helpers.
/*
namespace src
{
