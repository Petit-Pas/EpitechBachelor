...
// You may use this file to debug, understand or extend src features but we don't provide any guarantee of forward compatibility!
// Set:
...
#ifndef GImGui
extern IMGUI_API ImGuiContext* GImGui;  // Current implicit src context pointer
#endif
...
namespace ImGui
{
    ...
    // - src::NewFrame() has never been called, which is illegal.
    // - You are calling src functions after src::Render() and before the next src::NewFrame(), which is also illegal.
