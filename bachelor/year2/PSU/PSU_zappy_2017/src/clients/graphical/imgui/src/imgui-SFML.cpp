...
void Update(sf::Window& window, sf::RenderTarget& target, sf::Time dt)
{
    ...
    window.setMouseCursorVisible(!ImGui::GetIO().MouseDrawCursor); // don't draw mouse cursor if src draws it
}
...
void Shutdown()
{
    ...
    ImGui::Shutdown(); // need to specify namespace here, otherwise src::SFML::Shutdown would be called
}
