/*
** get_cylinder.c for RTV2 in /home/Lucas/delivery/MUL/raytracer2/Lucas
**
** Made by Lucas Dumy
** Login   <lucas.dumy@epitech.eu>
**
** Started on  Wed May 24 22:05:06 2017 Lucas Dumy
** Last update Sun May 28 17:16:45 2017 Lucas Dumy
*/

#include	<stdlib.h>
#include	"parsing.h"

static int	cylinder_error(char **tab, int line)
{
  int		i;
...
void		get_cylinder(t_fig *node, char **tab, int line)
{
  if (cylinder_error(tab, line) == 1)
    {
      node->id = -1;
      return ;
    }
